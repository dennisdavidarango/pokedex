...
const Teams = (props: ITeamsProps) => {
  ...
  function createTeam() {
    try {
      ...
      setNoticeMessage('Teams has been created')
    } catch (er) {
      console.log(er)
    }
  }
    ...
    <SafeAreaView style={TeamsStyles.container}>
      ...
      <View>
        <View style={TeamsStyles.headerContainer}>
          <View style={TeamsStyles.containerCenter}>
            <TouchableOpacity
              onPress={() => {
                setselectedPokemonsMap([])
                actions.resetState()
          ...
          <TouchableOpacity
            ...
            style={TeamsStyles.teamsButton}
          >
            <Text style={TeamsStyles.buttonText}>Teams</Text>
          </TouchableOpacity>
        </View>
        <View
          style={{
        ...
        >
          <Text style={TeamsStyles.subHeaderText}>
            Select a between 3 or 6 pokemon
          </Text>
          <TextInput
            value={teamName}
        ...
        {teamName ? (
          <TouchableOpacity
            onPress={createTeam}
            disabled={
              selectedPokemonsMap.length > 6 || selectedPokemonsMap.length < 3
                ? true
                : false
            }
            style={TeamsStyles.createTeamButton}
          >
          ...
          <PokemonItem
            ...
            onPress={() => {
              ...
              if (selectedPokemonsMap.length <= 3 && findValue) {
                ...
                setNoticeMessage('You cannot select less than 3 pokemons.')
              } else {
                if (selectedPokemonsMap.length >= 6 && !findValue) {
                  ...
                  setNoticeMessage('You cannot select more than 6 pokemons.')
                } else {
                  if (findValue) {
                    ...
                    setselectedPokemonsMap([...selectedPokemonsMap, pokemon])
                  }
                }
              }
            }}
